...
DB_DUCK = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "legacy_stockdb.duckdb")
H5I_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "h5i")
H5I_PATH = os.path.join(H5I_DIR, "market.db")
OUT = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "h5i_ingest_report.json")
