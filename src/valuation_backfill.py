...
if __name__ == "__main__":
    ...
    p2.add_argument("--out", default=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "approx_pb_rows.parquet"))
    p3 = sub.add_parser("snapshot-merge")
    p3.add_argument("--day", default=None)
    p4 = sub.add_parser("rebuild")
    p4.add_argument("--approx", default=os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "approx_pb_rows.parquet"))
