import os
import duckdb, json
con = duckdb.connect(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "legacy_stockdb.duckdb"), read_only=True)

# Check the pool_snapshot for 2026-09-02
pool_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "daily", "20260902", "pool_snapshot.json")
...
sel_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "data", "daily", "20260902", "selection.json")
